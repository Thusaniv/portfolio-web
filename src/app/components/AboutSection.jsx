...
const AboutSection = () => {
  ...
  return (
    ...
    <h2 className="text-5xl font-extrabold font-sans bg-gradient-to-b from-white to-secondary text-transparent bg-clip-text mb-6">
      ...
      <div className="bg-gradient-to-r from-[#3b4b69] to-[#1E1E1E] p-8 rounded-2xl shadow-2xl transform transition-transform duration-300 hover:scale-105 max-w-6xl w-full">
