      ...
      {items.map((item, idx) => (
        <div
          ...
          <Image
                ...
                src={item.image}
                alt={item.name}
    className="relative !m-0 h-17 w-17 rounded-full bg-gradient-to-r from-primary to-white object-cover object-top !p-0.5 transition duration-500 group-hover:z-30 group-hover:scale-110" />
        </div>
      ))}
    </>
  );
